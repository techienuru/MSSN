                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <small>Add and manage all faculties</small>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="faculty" placeholder="Eg: Natural and Applied Science" required>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header d-flex">
                    <h5 class="modal-title" id="editFacultyModalLabel">Edit PQ</h5>
                ...
                <div class="modal-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="faculty" value="Social Science" required>
                        </div>
